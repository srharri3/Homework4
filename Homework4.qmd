...
```{r}
glass |>
  mutate(Type_of_glass = ifelse(Type_of_glass == 1, "building_windows_float_processed",Type_of_glass),
      ifelse(Type_of_glass == 2,"building_windows_non_float_processed",Type_of_glass),
      ifelse(Type_of_glass == 3,"vehicle_windows_float_processed",Type_of_glass),
      ifelse(Type_of_glass == 4, "vehicle_windows_non_float_processed", Type_of_glass),
      ifelse(Type_of_glass == 5,"container",Type_of_glass),
      ifelse(Type_of_glass == 6,"tableware",Type_of_glass),
      ifelse(Type_of_glass == 7,"headlamp",Type_of_glass)) |>
